    ...
    public function actionIndex() {
        ...
        if (isset($_GET['tag']) && isset($_GET['findBy']) && isset($_GET['query']) && isset($_GET['query2'])) {
            ...
            if (Yii::$app->request->get() && addslashes($_GET['action']) === "browse") {
                ...
                $command = Yii::$app->db->createCommand("CALL insertTempTelusurOpac('" . $tag . "','" . $findBy . "','" . $query . "','" . $query2 . "','" . $fAuthor . "','" . $fPublisher . "','" . $fPublishLoc . "','" . $fPublishYear . "','" . $fSubject . "','1');");
                $command->execute();
                ...
                $sqlSearch = "CALL pencarianSederhanaOpacLimit1(" . $limitAwal . ",'" . $limit . "','" . $fAuthor . "','" . $fPublisher . "','" . $fPublishLoc . "','" . $fPublishYear . "','" . $fSubject . "');";
        ...
        if (isset($_GET['tag'])) {
            ...
            if (isset($_GET['findBy'])) {
                ...
                $sql = "call BrowseOpac('" . addslashes($_GET['findBy']) . "','','','1');";
                ...
                if (isset($_GET['query'])) {
                    $sql2 = "call BrowseOpac('" . addslashes($_GET['findBy']) . "','" . addslashes($_GET['tag']) . "','" . addslashes($_GET['query']) . "','1');";
