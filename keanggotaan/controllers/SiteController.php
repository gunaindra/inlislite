...
class SiteController extends Controller
{
    ...
    public function actionDaftarPeminjaman()
    {
        ...
        $dataProvider = $searchModel->advancedSearch('Loan',false);
    ...
    public function actionDaftarPengembalian()
    {
        ...
        $searchModel = new \common\models\CollectionloanitemSearch;
        $dataProvider = $searchModel->advancedSearch('Return',false);
    ...
    public function actionDaftarPerpanjangan(){
        ...
        $searchModel->Member_id =  $searchModel->getMemberID(Yii::$app->user->identity->NoAnggota);
        $dataProvider = $searchModel->search(Yii::$app->request->getQueryParams());
