    ...
    <?php Pjax::begin(); echo GridView::widget([
        ...
        'columns' => [
            ...
            ['class' => 'yii\grid\SerialColumn'],
             ['attribute'=>'tanggal_pinjam','format'=>['datetime',(isset(Yii::$app->modules['datecontrol']['displaySettings']['datetime'])) ? Yii::$app->modules['datecontrol']['displaySettings']['datetime'] : 'd-m-Y H:i:s A']], 
