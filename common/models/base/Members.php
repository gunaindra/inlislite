...
class Members extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['DateOfBirth', 'RegisterDate', 'EndDate', 'CreateDate', 'UpdateDate', 'TanggalBebasPustaka', 'KIILastUploadDate'], 'safe'],
            [['IdentityType_id', 'EducationLevel_id', 'Sex_id', 'MaritalStatus_id', 'Job_id', 'JenisPermohonan_id', 'JenisAnggota_id', 'StatusAnggota_id', 'LoanReturnLateCount', 'Branch_id', 'CreateBy', 'UpdateBy', 'Kelas_id', 'Agama_id', 'Jurusan_id','ProgramStudi_id', 'Fakultas_id', 'UnitKerja_id'], 'integer'],
