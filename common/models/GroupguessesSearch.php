...
class GroupguessesSearch extends Groupguesses
{
    ...
    public function rules()
    {
        return [
            ...
            [['NamaKetua', 'NomerTelponKetua', 'AsalInstansi', 'AlamatInstansi', 'CreateDate', 'CreateTerminal', 'UpdateDate', 'UpdateTerminal', 'TeleponInstansi', 'EmailInstansi', 'Information', 'NoPengunjung','libraryID','locationName','locationlocationLibraryName'], 'safe'],
        ];
    }
