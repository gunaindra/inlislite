...
class Members extends BaseMembers
{
    ...
    public function rules()
    {
        return [
            ...
            ['crop_info', 'safe'],
            [['TglLahir','MemberNo', 'Fullname','IdentityNo','Sex_id','IdentityType_id','StatusAnggota_id','TglRegisterDate', 'TglEndDate'], 'required'],
            [['MemberNo', 'IdentityNo'],'unique'],
            [['DateOfBirth', 'RegisterDate', 'EndDate', 'CreateDate', 'UpdateDate'], 'safe'],
            [['IdentityType_id', 'EducationLevel_id', 'MaritalStatus_id', 'Job_id', 'JenisPermohonan_id', 'JenisAnggota_id', 'StatusAnggota_id', 'LoanReturnLateCount', 'Branch_id', 'Kelas_id', 'Agama_id', 'Jurusan_id', 'Fakultas_id','ProgramStudi_id', 'UnitKerja_id'], 'integer'],
            [['IsLunasBiayaPendaftaran'], 'boolean'],
            [['BiayaPendaftaran'], 'number'],
            [['MemberNo', 'Fullname', 'PlaceOfBirth', 'Address', 'AddressNow', 'Phone', 'InstitutionName', 'InstitutionAddress', 'InstitutionPhone', 'IdentityNo', 'MotherMaidenName', 'Email', 'NoHp', 'NamaDarurat', 'TelpDarurat', 'AlamatDarurat', 'StatusHubunganDarurat', 'KeteranganLain'], 'string', 'max' => 255],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'JenisAnggota_id' => Yii::t('app', 'JenisAnggota_id'),
            'StatusAnggota_id' => Yii::t('app', 'StatusAnggota_id'),
