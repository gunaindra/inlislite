...
class MemberguessesSearch extends Memberguesses
{
    ...
    public function search($params)
    {
        ...
        ->addSelect([' memberguesses.ID , memberguesses.Nama , memberguesses.NoAnggota, memberguesses.Alamat, memberguesses.CreateDate,memberguesses.NoPengunjung,memberguesses.Location_Id,
         ...
         (CASE WHEN memberguesses.NoAnggota IS NOT NULL THEN members.Sex_id ELSE memberguesses.JenisKelamin_id END) AS JenisKelamin_id'])
