...
class Collections extends BaseCollections
{
    ...
    public function rules()
    {
        return [
            ...
            [[ 'NOJILID','TanggalPengadaan', 'CreateDate', 'UpdateDate', 'QUARANTINEDDATE', 'TANGGAL_TERBIT_EDISI_SERIAL', 'TGLENTRYJILID','BookingMemberID', 'BookingExpiredDate'], 'safe'],
            [['JumlahEksemplar','Branch_id', 'IsVerified', 'NOJILID','UpdateBy','CreateBy', 'QUARANTINEDBY', 'JILIDCREATEBY'], 'integer'],
