...
Yii::$app->view->params['subTitle'] = '<h3 style="padding-top: 15px;">Selamat Datang <br> Survey Terhadap Pemustaka<h3>';
    ...
    <div class="modal-dialog">
        <div class="">
            <div class="modal-header">
                ...
                <h4 class="modal-title text-center">Silahkan memilih Survey</h4>
            </div>
