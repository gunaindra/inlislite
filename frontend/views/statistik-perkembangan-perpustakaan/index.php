...
$this->title = 'Statistik Perkembangan Perpustakaan';
Yii::$app->view->params['subTitle'] = '<h3 style="padding-top: 15px;">Selamat Datang <br> Statistik Perkembangan Perpustakaan<h3>';
            ...
            <div class="box-body">
                ...
                echo HighCharts::widget([
                    'clientOptions' => [
                        ...
                        // ],
                        'title' => [
                             'text' => 'Berdasarkan Jenis Pengunjung',
                             'x' => -20
                             ],
                        'subtitle' => [
                             'text' => $rangeTahun,
            ...
            <div class="box-body">
                ...
                echo HighCharts::widget([
                    'clientOptions' => [
                        ...
                        'title' => [
                             'text' => 'Pertumbuhan Jumlah Koleksi',
                        ],
                        'subtitle' => [
                             'text' => $rangeTahun,
                             ],
            ...
            <div class="box-body">
                ...
                echo HighCharts::widget([
                    'clientOptions' => [
                        ...
                        'title' => [
                             'text' => 'Pertumbuhan Jumlah Koleksi Dipinjam',
                        ],
                        'subtitle' => [
                             'text' => $rangeTahun,
                             ],
            ...
            <div class="box-body">
                ...
                echo HighCharts::widget([
                    'clientOptions' => [
                        ...
                        'title' => [
                             'text' => 'Pertumbuhan Jumlah Koleksi Dibaca',
                        ],
                        'subtitle' => [
                             'text' => $rangeTahun,
                             ],
