...
<div class="login-box">
    ...
    <div style="opacity: 0.90; text-shadow: 2px 2px #333333; font-family: 'Candara';">
        <span style="font-weight: bold;font-size: 20px;color: white"> Pilih Lokasi Perpustakaan </span>
...
<!--        <img src="css/images/sign_in.png" alt=""/>-->
    ...
    <!-- /.login-box-body -->
        ...
        <div id="footer"> <span class="inlislite">Inlislite V3 © <?=date('Y')?> </span> <span class="perpus">  Perpustakaan Nasional Republik Indonesia</span></div>
        </center>
</div>
<?php
$script = <<< JS
