        ...
        try{
                    ...
                    foreach ($data as $row) {
                        ...
                        if(is_null($statusPerkawinan)){
                            ...
                            $masterStatusPerkawinan->Name = Helpers::collapseSpaces($row['STATUS PERKAWINAN']);
                       ...
                       // CHECK MASTER STATUS ANGGOTA
                        ...
                        $jenisAnggota = \common\models\JenisAnggota::find()->where(['jenisanggota' => Helpers::collapseSpaces($row['STATUS ANGGOTA'])])->one();
                        ...
                        if(is_null($kelas)){
                            ...
                            $masterKelas->namakelassiswa = Helpers::collapseSpaces($row['STATUS ANGGOTA']);
                            $masterKelas->save();
