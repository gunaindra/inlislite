...
$ajaxOptions    = [
                   ...
                   'success'=>new yii\web\JsExpression('function(data){
                      if(data == "1"){
                        alertSwal("BERHASIL : Password Keanggotaan Online sudah direset \n Passwordnya adalah member123","success","2000");

                      }else{
                        alertSwal("Password Gagal diReset","warning","2000");
...
<!-- Button -->
        ...
        <div class="pull-left">
            ...
            <?php
            echo '<p>';
            echo  Html::submitButton($model->isNewRecord ? Yii::t('app', 'Create') : Yii::t('app', 'Create'), ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary btn-sm']);
    ...
    <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                  ...
                  <li><a href="#peminjaman" data-toggle="tab"><?= Yii::t('app','Data Peminjaman')?></a></li>
                  <li>
