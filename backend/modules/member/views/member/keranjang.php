...
<div class="form-group" style="padding-bottom:30px">
  ...
  <div class="col-md-2">' . Select2::widget([
   ...
   <div class="col-md-4" style="margin-left: -21px;">'.
     Html::submitButton('<i class="glyphicon glyphicon-check"></i> Proses', [
                        'id'=>'btnCheckprocess',
                        'class' => 'btn btn-primary btn-sm ', 
                        'title' => 'Proses', 
                        'data-toggle' => 'tooltip'
 ...
 Html::submitButton('<i class="glyphicon glyphicon-check"></i> Kosongkan keranjang anggota', [
                        'id'=>'btnDeleteAllKeranjang',
                        'class' => 'btn btn-danger btn-sm ', 
                        'title' => 'Klik untuk kosongkan keranjang anggota', 
                        'data-toggle' => 'tooltip'
                    ])   
    .'</div>
</div>'
