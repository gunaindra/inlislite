...
$imageOriginal = MemberHelpers::getPathFotoAnggotaOriginal() . $model->ID . ".jpg?timestamp=" . rand();
//echo $image;
$img = Yii::getAlias('@uploaded_files') . '/foto_anggota/' . $model->ID . '.jpg';
$imgTemp = Yii::getAlias('@uploaded_files') . '/foto_anggota/temp/' . $model->ID . '.jpg';

if (!file_exists($imgTemp)) {
    $image = MemberHelpers::getPathFotoAnggota() . "nophoto.jpg?timestamp=" . rand();
    $imageOriginal = MemberHelpers::getPathFotoAnggotaOriginal() . "nophoto.jpg?timestamp=" . rand();
} else {
    $image = MemberHelpers::getPathFotoAnggota() . $model->ID . ".jpg?timestamp=" . rand();
    $imageOriginal = MemberHelpers::getPathFotoAnggotaOriginal() . $model->ID . ".jpg?timestamp=" . rand();
}
?>
...
<?php } ?>
    ...
    <div class="col-sm-6">
        ...
        <div id="frameFotoDef" class="img-frame-fotoaa">
            <?php
            echo Html::img($image, ['id' => 'fotoanggota', 'class' => 'img-thumbnail', 'style' => ['max-height' => '200px', 'margin-bottom' => '5px']]);
...
<?php } ?>
     ...
     <!-- Masa Berlaku -->
        ...
        <label class="control-label col-md-3" for="members-tglenddate1">Masa Berlaku</label>
        <div class="col-md-9">
