...
<div class="container-card" style="background-image: url(<?=$frontImage?>); background-repeat: no-repeat; background-size: 100% 100%; ">
    <div class="main">
        ...
        <div class="" style="padding-top: 95px; margin-left: 22px; float: left; font-weight: bold ;font-size: 16px;">
            <?php echo $model->Fullname; ?> <br>
            <span style="font-size: 14px; margin-top: -10; font-weight: normal;"><?=$model->MemberNo?></span>
        </div>
