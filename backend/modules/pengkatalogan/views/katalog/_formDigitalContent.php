                        ...
                        <div class="col-sm-12">
                          <table class="InfoTable" cellpadding="0" cellspacing="0" border="0" style="background-color: #FFFFCC; width: 100%;">
                            ...
                            <tr>
                                ...
                                <td  style="padding: 5px">
                                    Untuk mengunggah Flipbook dalam bentuk flash. Lakukan kompresi dalam bentuk file zip/rar.
                                </td>
                            </tr>
                        </tbody></table>
                        </div>
...
<?php 
echo '<div style=width:70% class=row><div class=col-sm-1>Aksi</div><div class=col-sm-3>'
                        .Select2::widget([
                        'id' => 'cbActioncheckboxKontenDigital',
                        'name' => 'cbActioncheckboxKontenDigital',
                        'data' => ['DOWNLOAD'=>'Download File','OPAC'=>'Tampil di OPAC','REMOVE'=>'Hapus File'],
                        'size'=>'sm',
                        'pluginEvents' => [
                                                            ...
                                                            function(){   
                                                              $.ajax({
                                                                  ...
                                                                  success : function(response) {
                                                                      ...
                                                                      if(response==true)
                                                                      {
                                                                        alertSwal("Data berhasil dihapus!", "success","2000");
                                                                      }else{
                                                                        alertSwal("Data gagal dihapus!", "error","2000");
                                                                      }
                                                                  },
                                                              });
                                                            });
...
<?php 
    ...
    $(document).ready(function(){
        $(\'#btnCheckprocessKontenDigital\').click(function(){
            ...
            if(CekId.length == 0){
                alertSwal(\'Harap pilih konten digital.\',\'error\',\'2000\');
                return;
            }
            if (CekAction === \'REMOVE\')
            {
              ...
              $.ajax({
                      ...
                      success : function(response) {
                          ...
                          $.pjax.reload({container:"#myGridviewKontenDigital", async:false});
                          alertSwal("Data berhasil diproses!", "success","2000");
                      }
                  });
            }
