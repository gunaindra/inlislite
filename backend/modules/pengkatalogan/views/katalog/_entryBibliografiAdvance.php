                ...
                <h4 class="box-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
                      Data Bibliografis
                              ...
                              <div class="col-xs-6 col-sm-6">
                                  <small><?php echo Html::a("<i class='glyphicon glyphicon-th-large'></i> Tampilkan Sederhana", '#', ['id'=>'btn-change-simple','class' => 'btn bg-navy floating-topright2  pull-right btn-sm' ,'onclick'=>'js:BibliografisToogleForm("simple")']); ?></small>
                                  </div>
                        </div>
