...
<?php 
 ...
 'columns' => [
            ...
            [
                ...
                'label'=>Yii::t('app','Lokasi Sblmnya')
            ],
            [
                ...
                'editableOptions' => function($model) {
                    ...
                    return [
                        ...
                        'displayValueConfig'=> $locations,
                    ];
                },
                'value'=>'currentLocation.Name',
                'label'=>Yii::t('app','Lokasi Skrng')

            ],
            // [
            //     'attribute'=>'CurrentLocationID',
            //     'value'=>'currentLocation.Name',
            //     'label'=>Yii::t('app','Nama Lokasi Skrng')
            // ],
            [
                'attribute'=>'PrevStatusID',
                'value'=>'prevStatus.Name',
                // 'width'=>'90px',
                'label'=>Yii::t('app','Ketersediaan Sblmnya')
            ],
            [
            	'class'=>'kartik\grid\EditableColumn',
                ...
                'label'=>Yii::t('app','Ketersediaan Skrng')
            ],
            [
            ...
            [
            	'class'=>'kartik\grid\EditableColumn',
                'attribute' => 'CurrentCollectionRuleID',
                //'refreshGrid' => true,
                'editableOptions' => function($model) {
                	$rules = ArrayHelper::map(\common\models\Collectionrules::find()->all(),'ID','Name');
                    return [
                        'inputType' => \kartik\editable\Editable::INPUT_SELECT2,
                        'placement'=>'left',
                        'size'=>'sm',
                        'name' => 'CurrentCollectionRuleID',
                        'options' => [ // your widget settings here
                            'data' => $rules,
                            
                        ],
                        'displayValueConfig'=> $rules,
                    ];
                },
                'value'=>'currentCollectionRule.Name',
                'label'=>Yii::t('app','Akses Skrng')
            ],
...
<?php echo GridView::widget([
	...
	'columns' => [
		...
		[
			'attribute'=>'JumlahStatusTidak diketahui',
		...
		[
			'attribute'=>'JumlahStatusDalam Perbaikan',
		...
		[
			'attribute'=>'JumlahStatusDalam Pengadaan',
			'header'=>'Tercatat Dalam Pengadaan',
			'pageSummary'=>true,
			'footer'=>true
		],
		[
