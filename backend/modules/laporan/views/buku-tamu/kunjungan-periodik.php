...
$this->title = 'Laporan Kunjungan Periodik';
            ...
            <div class="form-horizontal">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10 row">
                            <div class="checkbox">
                                <label style="margin-right: 50px;"><input type="checkbox" Name="anggota" value="anggota"> Anggota </label>
                                <label style="margin-right: 50px;"><input type="checkbox" Name="non_anggota" value="non_anggota"> Non Anggota</label>
                                <label style="margin-right: 50px;"><input type="checkbox" Name="rombongan" value="rombongan"> Rombongan</label>
                            </div> 
                        </div>
                    </div>
