...
$kriteria = ['' => 'Semua Kriteria',
        'location_library' => 'Nama Lokasi Perpustakaan',
        'locations' => 'Nama Ruang Perpustakaan'
        ];
?>
            ...
            <div class="form-horizontal">
                <div class="box-body">
                    ...
                    <div class="form-group" style="margin-top: -10px; margin-left:-5px;">
                        ...
                        <div class="col-sm-10 row">
                            <div class="checkbox">
                                <label style="margin-right: 50px;"><input type="checkbox" Name="belum_dikembalikan" value="belum_dikembalikan"> Belum dikembalikan </label>
                                <label style="margin-right: 50px;"><input type="checkbox" Name="sudah_dikembalikan" value="sudah_dikembalikan"> Sudah dikembalikan</label>
                            </div> 
                        </div>
                    </div>

                        <label for="pilihKriteria" class="col-sm-2 control-label" ><?= Yii::t('app','Kriteria Loker') ?> </label>
