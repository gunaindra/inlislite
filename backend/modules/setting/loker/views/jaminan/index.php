                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-4" style="padding: 0;">
                                	<?= Html::activeCheckbox($model, 'JaminanUangLoker', ['class' => 'text-default','label' => '  Aktifkan']); ?>
                                </div>
                ...
                <table class="table" style="table-layout: fixed;">
                    <thead>
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-4" style="padding: 0;">
                                	<?= Html::activeCheckbox($model, 'JaminanIdentitasLoker', ['class' => 'text-default','label' => '  Aktifkan']); ?>
                                </div>
                ...
                <table class="table" style="table-layout: fixed;">
                    <thead>
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-4" style="padding: 0;">
                                	<?= Html::activeCheckbox($model, 'CetakBuktiTransaksi', ['class' => 'text-default','label' => '  Aktifkan']); ?>
                                </div>
                ...
                <table class="table" style="table-layout: fixed;">
                    <thead>
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-4" style="padding: 0;">
                                	<?= Html::activeCheckbox($model, 'CetakBuktiPelanggaran', ['class' => 'text-default','label' => '  Aktifkan']); ?>
                                </div>
                ...
                <table class="table" style="table-layout: fixed;">
                    <thead>
                        <tr>
                            ...
                            <td>
                                <div class="col-sm-4" style="padding: 0;">
                                	<?= Html::activeCheckbox($model, 'IsMemberAllowedToBorrowMultipleLocker', ['class' => 'text-default','label' => '  Aktifkan']); ?>
                                </div>
