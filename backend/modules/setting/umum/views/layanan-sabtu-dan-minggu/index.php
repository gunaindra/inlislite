...
$this->title = Yii::t('app', 'Pengaturan Layanan Sabtu dan Minggu');
...
<div class="settingparameters-create">
    ...
    <div class="settingparameters-form">
        <div class="form-group">
            <?php $form = ActiveForm::begin(['type'=>ActiveForm::TYPE_HORIZONTAL]); ?>
            <?= $form->field($model, 'IsSaturdayHoliday')->checkbox(array('label'=>'Ya'))->label('Hari Sabtu Libur?'); ?>	
            <?= $form->field($model, 'IsSundayHoliday')->checkbox(array('label'=>'Ya'))->label('Hari Minggu Libur?'); ?>
