...
<div class="jenis-perpustakaan-form">
    <div class="col-sm-8">
        ...
        <div class="row" >
            <?= $form->field($model, 'username',[ 'options' => ['class'=>'col-sm-8']])->textInput(['placeholder' => Yii::t('app', 'Enter') . ' ' . Yii::t('app', 'Username')])->label(Yii::t('app', 'Username') ) ?>

            <?= $form->field($model, 'Fullname', [ 'options' => ['class'=>'col-sm-8']])->textInput(['placeholder' => Yii::t('app', 'Enter') . ' ' . Yii::t('app', 'Fulllname')])->label(Yii::t('app', 'Fullname') ) ?>
        ...
        <?php
        echo $form->field($model, 'IsActive',[ 'options' => ['class'=>'col-sm-8']])->checkbox(['label' => 'Aktif']);
    ...
    <?php if ($model->isNewRecord): ?>
        <div class="col-sm-8">
            <div class="row">
                <div class="col-sm-12">
                    <hr/>
                    <h4 class="text-danger">Hak Akses User dapat ditambahkan setelah data user tersimpan</h4>
                    <hr/>
                </div>
            </div>
        </div>
    ...
    <div class="col-sm-12">
        <div class="row" >
            ...
            <div class="col-sm-2" style="padding-top: 15px; text-align: right;">
                <label class="control-label ">Hak Lokasi Perpustakaan</label>
            </div>

            <div class="col-sm-10 " style="padding:0; padding-top: 15px">
                <div class="col-sm-3 padding0">
                    <?php echo $form->field($model2, 'LocLib_id',[ 'options' => ['class'=>'col-sm-12 padding0 kecilin']])->checkboxList(ArrayHelper::map(LocationLibrary::find()->all(), 'ID', 'Name'))->label('Koleksi',['class'=>'col-sm-12']);?>
                </div>
                <div class="col-sm-3 padding0">
                    <?php echo $form->field($model3, 'LocLib_id',[ 'options' => ['class'=>'col-sm-12 padding0 kecilin']])->checkboxList(ArrayHelper::map(LocationLibrary::find()->all(), 'ID', 'Name'))->label('Sirkulasi',['class'=>'col-sm-12']);?>
                </div>
            </div>
        </div>
        <?php ActiveForm::end();
