...
<div class="settingparameters-form col-sm-6">
  <div class="form-group">
    ...
    <?= $form->field($model, 'TipePenomoranAnggota')->widget(Select2::classname(), [
        'data' => ['1' => 'Pilihan 1', '2' => 'Pilihan 2', '3' => 'Pilihan 3', '4' => 'Pilihan 4'],
    ...
    <?= $form->field($model, 'IsCetakSlipPerpanjangan')->checkbox(array('label'=>'Ya/ Tidak'))->label('Cetak Slip Perpanjangan');; ?>	
   
    <?= $form->field($model, 'IsCetakSlipPelanggaran')->checkbox(array('label'=>'Ya/ Tidak'))->label('Cetak Slip Pelanggaran');; ?>
   
    <?= $form->field($model, 'IsCetakSlipPendaftaran')->checkbox(array('label'=>'Ya/ Tidak'))->label('Cetak Slip Pendaftaran');; ?>
