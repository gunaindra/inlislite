...
<div class="jenis-perpustakaan-form">
    <div class="col-sm-6">
        ...
        echo $form->field($model, 'klain_fisik')->checkbox(array('label'=>'Ya'))->label('Kelainan Fisik');
        echo $form->field($model, 'aktalhr')->checkbox(array('label'=>'Ya'))->label('Akta Lahir');
        echo $form->field($model, 'aktakawin')->checkbox(array('label'=>'Ya'))->label('Akta Kawin');
        echo $form->field($model, 'aktacerai')->checkbox(array('label'=>'Ya'))->label('Akta Cerai');
