...
<div class="jenis-anggota-form">
    ...
    echo Form::widget([
        ...
        'attributes' => [
            ...
            'DayPerpanjang' => ['type' => Form::INPUT_TEXT, 'options' => ['placeholder' => Yii::t('app', 'Enter') . ' ' . Yii::t('app', 'Max Lama Perpanjangan') . '...', 'maxlength' => 10],'label'=>Yii::t('app', 'Max Lama Perpanjangan'),'hint'=>'hari'],
