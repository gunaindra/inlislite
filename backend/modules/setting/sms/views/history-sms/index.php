...
$this->title = Yii::t('app', 'History Pengiriman SMS');
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Setting'), 'url' => ['#']];
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'SMS'), 'url' => Url::to(['/setting/sms'])];
$this->params['breadcrumbs'][] = 'History Pengiriman SMS';
?>
...
<div class="collectioncategorys-index">
    ...
    <?php Pjax::begin(['id' => 'myGridview']);; echo GridView::widget([
        ...
        'floatHeader'=>false,
        'panel' => [
            'heading'=>'<h3 class="panel-title"><i class="glyphicon glyphicon-th-list"></i> History Pengiriman SMS </h3>',
            'type'=>'info',
