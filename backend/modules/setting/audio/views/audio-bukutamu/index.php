...
<?php if ($existFile == true): ?>
	...
	<div class="col-sm-12" style="padding-top: 10px;">
		...
		<button type="button" class="btn btn-warning" id="btnChangeAudio">Ubah</button>
		<!-- <h4 class="text-danger">Audio Buku tamu sudah di set, Klik button ubah untuk menampilkan form merubah audio</h4> -->
		<hr>
	</div>
<?php else: ?>
	<div class="col-sm-12">
		<h4 class="text-success">Audio Buku tamu belum di set, Silahkan upload file terlebih dahulu untuk mengaktifkan</h4>
	</div>
<?php endif ?>
