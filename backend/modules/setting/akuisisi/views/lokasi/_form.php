...
<div class="row">
    <label class="control-label col-md-2" style=""><u>Buku Tamu</u></label>
</div>
<div class="row">
    <div class="col-sm-12">
        <div class="form-group field-locations-description">
            <label class="control-label col-md-2" for="locations-description">Pilihan Pertanyaan Kunjungan</label>
            <div class="col-md-10">
            <?php
...
// echo '<label class="control-label col-md-2">Pilihan Pertanyaan Kunjungan</label>';
            echo Select2::widget([
                'name' => 'pertanyaan',
                'value' => $pertanyaan,
                'data' => [0 => '-- Tanpa Pilihan --', 'IsVisitsDestination' => Yii::t('app', 'Tampilkan ruas maksud kunjungan'), 'IsInformationSought' => Yii::t('app', 'Tampilkan ruas informasi yang dicari')],
                // 'options' => ['width'=>'250px'],
