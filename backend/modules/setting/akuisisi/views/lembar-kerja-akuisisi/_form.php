            ...
            [
                ...
                'checkboxOptions' => function ($searchModel, $key, $index, $column) {
                    return [
                        ...
                        'onchange' => 'var checked = $(this).is(":checked");$.ajax("lembar-kerja-akuisisi/is-akuisisi", {data: {id: $(this).closest("tr").data("key"), checked: checked}});',
                    ];
                }
            ],
...
<p><i>Catatan : Data otomatis tersimpan ketika cek dicentang atau tidak dicentang.</i> </p>
</div>
