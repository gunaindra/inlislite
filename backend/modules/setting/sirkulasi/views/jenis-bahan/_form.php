...
<div class="location-library-form">
    ...
    echo Form::widget([
        ...
        'attributes' => [
            ...
            'MaxLoanDays' => ['type' => Form::INPUT_TEXT, 'options' => ['style'=>'width: 10%;','placeholder' => Yii::t('app', 'Enter') . ' ' . Yii::t('app', 'Nama') . '...', 'maxlength' => 255],'label'=>Yii::t('app','Maks. Lama Pinjam'),'hint'=>'Hari'],
            
            'WarningLoanDueDay' => ['type' => Form::INPUT_TEXT, 'options' => ['style'=>'width: 10%;','placeholder' => Yii::t('app', 'Enter') . ' ' . Yii::t('app', 'Nama') . '...', 'maxlength' => 255],'label'=>Yii::t('app','Jeda Hari Peringatan Peminjaman utk Kembali'),'hint'=>'Hari'],
            
            'DayPerpanjang' => ['type' => Form::INPUT_TEXT, 'options' => ['style'=>'width: 10%;','placeholder' => Yii::t('app', 'Enter') . ' ' . Yii::t('app', 'Nama') . '...', 'maxlength' => 255],'label'=>Yii::t('app','Maks. Lama Perpanjang'),'hint'=>'Hari'],

            'CountPerpanjang' => ['type' => Form::INPUT_TEXT, 'options' => ['style'=>'width: 10%;','placeholder' => Yii::t('app', 'Enter') . ' ' . Yii::t('app', 'Nama') . '...', 'maxlength' => 255],'label'=>Yii::t('app','Maks. Banyaknya Perpanjang'),'hint'=>'(jika diisi dengan 0 maka tidak boleh diperpanjang)'],
        ]
    ]);
...
<?php 
	...
	echo $form->field($model, 'DendaTenorMultiply')->input('number',['min'=>1,'style' => 'width: 10%;'])->label(Yii::t('app','Pengali Tenor Denda'))->hint('Kali');
	...
	echo $form->field($model, 'SuspendType')->radioList(array('Konstan'=>'Konstan','Berkelipatan'=>'Berkelipatan'), 
		//['inline'=>true]
		[
			'item' => function($index, $label, $name, $checked, $value) {
	...
	echo $form->field($model, 'DaySuspend')->input('number',['min'=>0,'style' => 'width: 10%;'])->label(Yii::t('app','Lama Skorsing'))->hint('Hari');
?>
...
<?= $form->field($model, 'SuspendTenorMultiply')->input('number',['min'=>1,'style' => 'width: 10%;'])->label(Yii::t('app','Pengali Tenor Skorsing'))->hint('Kali'); ?>
