        ...
        switch ($Model) {
            ...
            case 'lr3':
                ...
                foreach ($LabelData as $LabelData) { 
                    ...
                    $singleLabel .="<tr>";
                    $singleLabel .="<td colspan='2' style='height: 26px; font-family: Arial; font-size: 12px; border: solid 1px #000 ".$warna."'>";
                    $singleLabel .=$LabelData['NamaPerpustakaan'];
                    $singleLabel .="</td>";
                    $singleLabel .="</tr>";
                    $singleLabel .="<tr>";
                    $singleLabel .="<td style='border-left: solid 1px #000; border-right: solid 1px #000; border-bottom: solid 1px #000'>";
                    ...
                    $singleLabel .="</td>";
                    $singleLabel .="<td style='width:25%;font-family: Arial; font-size: 14px; border-right: solid 1px #000; border-bottom: solid 1px #000'>";
            ...
            case 'lr4':
                ...
                foreach ($LabelData as $LabelData) { 
                    ...
                    $singleLabel .="<table cellpadding='0px' cellspacing='0px' style='mso-cellspacing: 0px; padding: 6px; margin: 0px; text-align: center;'>";
                    $singleLabel .="<tr>";
                    $singleLabel .="<td style='width:75%;height: 30px; font-family: Arial; font-size: 12px; border: solid 1px #000;'>";
                    $singleLabel .=$LabelData['NamaPerpustakaan'];
                    $singleLabel .="</td>";
                    $singleLabel .="<td style='font-family: Arial; font-size: 14px; border-top: solid 1px #000; border-right: solid 1px #000; border-bottom: solid 1px #000 ".$warna."' rowspan='2'>";
                    $singleLabel .= str_replace("\r\n", "<br />", str_replace(" ", "<br />",$LabelData['CallNumber']));
                    $singleLabel .="</td>";
                    $singleLabel .="</tr>";
                    $singleLabel .="<tr>";
            ...
            case 'lr6':
                ...
                foreach ($LabelData as $LabelData) { 
                    ...
                    $singleLabel .="<table cellpadding='0px' cellspacing='0px' style='mso-cellspacing: 0px; padding: 6px; margin: 0px; text-align: center;'>";
                    $singleLabel .="<tr>";
                    $singleLabel .="<td style='height: 30px; font-family: Arial; font-size: 12px; border: solid 1px #000 ".$warna."'>";
                    $singleLabel .=$LabelData['NamaPerpustakaan'];
                    $singleLabel .="</td>";
                    $singleLabel .="</tr>";
                    $singleLabel .="<tr>";
                    $singleLabel .="<td style='height:65px;border-left: solid 1px #000; border-right: solid 1px #000; border-bottom: solid 1px #000'>";
            ...
            case 'br2':
                ...
                foreach ($LabelData as $LabelData) { 
                    ...
                    $singleLabel .="<tr>";
                    $singleLabel .="<td style='width:173px;height:52px;border: solid 1px #000;'>";
                    if($Model=='br2')
                    {
            ...
            case 'tj121-4':
                ...
                foreach ($LabelData as $LabelData) { 
                    ...
                    if($Model=='tj121-2' || $Model=='tj121-4')
                    {
                        ...
                        $padding='5';
                        $rowspan="rowspan='2'";
                        $bordertopcallnumber="border-top: solid 1px #000;";
                    }
                    ...
                    $callnumberColumn='';
                    $callnumberColumn .="<td ".$rowspan." style='width:25%;font-family: Arial; font-size: 14px; ".$bordertopcallnumber." border-right: solid 1px #000; border-bottom: solid 1px #000 ".$warna_callnumber."'>";
                    ...
                    $result .="<tr>";
                    $result .="<td ".$colspan." style='height: 40px; font-family: Arial; ".$fontsizeperpustakaan." border: solid 1px #000 ".$warna_perpustakaan."'>";
                    ...
                    $result .="</tr>";
                    $result .="<tr>";
                    $result .="<td style='height:80px;border-left: solid 1px #000; border-right: solid 1px #000; border-bottom: solid 1px #000'>";
            ...
            case 'gc121-4':
                ...
                foreach ($LabelData as $LabelData) { 
                    ...
                    $result .="<table cellpadding='0px' cellspacing='0px' style='width:".$labelWidth.";padding:".$padding."px;mso-cellspacing: 0px;  margin: 0px; text-align: center;'>";
                    $result .="<tr>";
                    $result .="<td ".$colspan." style='height: 30px; font-family: Arial; ".$fontsizeperpustakaan." border: solid 1px #000 ".$warna_perpustakaan."'>";
                    $result .=$LabelData['NamaPerpustakaan'];
                    $result .="</td>";
                    //jika tj121-2 / tj121-4
                    if($rowspan!=''){
            ...
            case 'a4-7':
                ...
                foreach ($LabelData as $LabelData) { 
                    ...
                    $callnumberColumn='';
                    $callnumberColumn .="<td style='font-family: Arial; font-size: 14px; border-left: solid 1px #000; border-right: solid 1px #000; border-bottom: solid 1px #000 '>";
                    $callnumberColumn .= str_replace("\r\n", "<br />", str_replace(" ", "<br />",$LabelData['CallNumber']));
                    $callnumberColumn .="</td>";
                    ...
                    $result .="<table cellpadding='0px' cellspacing='0px' style='width:".$labelWidth.";padding:".$padding."px;mso-cellspacing: 0px;  margin: 0px; text-align: center;'>";
                    $result .="<tr>";
                    $result .="<td style='height: 30px; font-family: Arial; ".$fontsizeperpustakaan." border: solid 1px #000 ".$warna_perpustakaan."'>";
                    $result .=$LabelData['NamaPerpustakaan'];
                    $result .="</td>";
                    $result .="</tr>";
                    $result .="<tr>";
                    $result .="<td style='height:60px;border-left: solid 1px #000; border-right: solid 1px #000; border-bottom: solid 1px #000'>";
            ...
            case 'a4-8':
                ...
                foreach ($LabelData as $LabelData) { 
                    ...
                    $result .="</td>";
                    $result .="<td style='height: 50px; width:212px;font-family: Arial; ".$fontsizeperpustakaan." border: solid 1px #000 ".$warna_perpustakaan."'>";
                    $result .=$LabelData['NamaPerpustakaan'];
                    $result .="</td>";
                    $result .="</tr>";
                    $result .="<tr>";
                    $result .="<td style='height:110px;border-left: solid 1px #000; border-right: solid 1px #000; border-bottom: solid 1px #000'>";
                    $result .=CollectionHelpers::getLabelCallNumber($LabelData['CallNumber']);
                    $result .="</td>";
                    $result .="</tr>";
                    $result .="</table>";
            ...
            case 'a4-9':
                ...
                foreach ($LabelData as $LabelData) { 
                    ...
                    $result .="</td>";
                    $result .="<td style='height: 40px; width:212px;font-family: Arial; ".$fontsizeperpustakaan." border: solid 1px #000 ".$warna_perpustakaan."'>";
                    $result .=$LabelData['NamaPerpustakaan'];
                    $result .="</td>";
                    $result .="</tr>";
                    ...
                    $result .="<tr>";
                    $result .="<td style='border-bottom:solid 1px #000; border-right:solid 1px #000;border-left:solid 1px #000; text-align: center'>";
                    ...
                    $result .="</tr>";
                    $result .="<tr>";
                    $result .="<td style='height: 30px;border-left: solid 1px #000; border-right: solid 1px #000; border-bottom: solid 1px #000'>";
