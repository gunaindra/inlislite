	...
	<td style="width:50%;padding-bottom: 25px; padding-right: 55px; text-align: left;">
		...
		<table style="width:212px; " cellpadding="0" cellspacing="0">
			<tr>
				...
				<td style="border:solid 1px #000; height:62px; text-align: center; width:212px; padding: 5px; font-size: 12px <?=$warna?>"><?=$LabelData['NamaPerpustakaan']?></td>
			</tr>
			<tr>
				<td style="height:150px; border-bottom:solid 1px #000; border-right:solid 1px #000;border-left:solid 1px #000; text-align: center"><?=\common\components\CollectionHelpers::getLabelCallNumber($LabelData['CallNumber'])?></td>
			</tr>
		</table>
	</td>
