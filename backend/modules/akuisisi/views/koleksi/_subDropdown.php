    ...
    case 'CETAKLABEL':
        echo '<div class="row form-group">';
            echo '<div class="col-md-4">';
                echo '<label for="inputType" class="control-label control-label-sm">Piih sumber No. Panggil</label>';
            echo '</div>';
            echo '<div class="col-md-8">';
            echo Html::radioList('cbActionLabel1', ['catalogs'], ['catalogs'=>'Katalog','collections'=>'Koleksi']);
            echo '</div>';
        echo '</div>';
        echo '<div class="row form-group">';
            echo '<div class="col-md-4">';
                echo '<label for="inputType" class="control-label control-label-sm">Piih ukuran kertas </label>';
            echo '</div>';
            echo '<div class="col-md-8">';
                echo Select2::widget([
                    'id' => 'cbActionLabel2',
                    'name' => 'cbActionLabel2',
                    'data'=>[
                        'label-roll'=>'Kertas Label Roll',
                        'barcode-roll'=>'Kertas Barcode Roll',
                        'label-tj121'=>'Kertas Label Tom & Jerry 121',
                        'label-gc121'=>'Kertas Label Golden Cock 121',
                        'a4'=>'Kertas A4',
                    ],
                    'size' => 'sm',
                    'pluginEvents' => [
        ...
        echo '<div class="row form-group">';
            echo '<div class="col-md-4">';
                echo '<label for="inputType" class="control-label control-label-sm">Piih model </label>';
            echo '</div>';
        ...
        echo '<div class="row form-group">';
            echo '<div class="col-md-4">';
                echo '<label for="inputType" class="control-label control-label-sm">Piih format dokumen</label>';
            echo '</div>';
            echo '<div id="label-model" class="col-md-8">';
                echo Select2::widget([
                    'id' => 'cbActionLabel4',
