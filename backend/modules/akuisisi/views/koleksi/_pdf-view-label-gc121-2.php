...
?>
	...
	<td style="width:50%;padding-bottom: 10px; padding-right: 10px; text-align: left;">
		<table style="width:287px; " cellpadding="0" cellspacing="0">
			<tr>
				<td style="border:solid 1px #000; height:53px; width:215px; text-align: center; "><?=$LabelData['NamaPerpustakaan']?></td>
				<td style="width:25%;border-top:solid 1px #000;border-bottom:solid 1px #000; border-right:solid 1px #000;text-align: center " rowspan="2"><?=str_replace(' ', '<br>', $LabelData['CallNumber'])?></td>
			</tr>
			<tr>
				<td style="height:90px; width:75%; text-align: center;padding-left: 3px; padding-right: 3px;border-left:solid 1px #000; border-bottom:solid 1px #000; border-right:solid 1px #000;">
					...
					<br>
					<?php 
					echo '<img style="padding-top:5px;width:215px" src="data:image/png;base64,' . base64_encode($generator->getBarcode($LabelData['Barcode'], $generator::TYPE_CODE_39,1)) . '">';
					?>
					<br>
					*<?=$LabelData['Barcode']?>*
					</span>
