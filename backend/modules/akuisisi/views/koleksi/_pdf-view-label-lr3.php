	...
	<?php foreach ($LabelData as $LabelData): ?>
		<table style="width: 100%;" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td style="border:solid 1px #00; height:47px; text-align: center; padding: 5px <?=$warna?>" colspan="2"><?=$LabelData['NamaPerpustakaan']?></td>
			</tr>
			<tr>
				...
				<td style="width:25%;border-bottom:solid 1px #000; border-right:solid 1px #000; float: right; text-align: center"><?=str_replace(' ', '<br>', $LabelData['CallNumber'])?></td>
			</tr>
		</table>
	<?php endforeach ?>
