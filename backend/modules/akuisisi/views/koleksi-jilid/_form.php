  ...
  <form role="form">
    <div class="box-body">
      ...
      <div class="form-group">
        <div class="row">
          <label class="control-label col-sm-2" for="email"><?php echo Html::label('Tahun Jilid'); ?></label>
          <div class="col-sm-4">
      ...
      <div class="form-group">
        <div class="row">
          ...
          <div class="col-sm-4">
            <?php echo Html::textInput('txtNoPanggilJilid',NULL,['class'=>'form-control','style'=>'width:100%','placeholder'=>Yii::t('app', 'Enter').' '.Yii::t('app', 'No. Panggil Jilid').'...']); ?>
          </div>
        </div>
      </div>
