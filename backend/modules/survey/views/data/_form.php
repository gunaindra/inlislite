...
<div class="survey-form">
    ...
    'attributes' => [
		...
		'TanggalMulai'=>['type'=> Form::INPUT_WIDGET, 'widgetClass'=>DatePicker::classname(),'options'=>['pluginOptions' => [
                                'format' => 'dd-mm-yyyy',
                                'autoclose' => true,
                                'todayHighlight' => true,
                            ]], ], 
  ...
  //                           ]], ], 
		...
		'TanggalSelesai'=>['type'=> Form::INPUT_WIDGET, 'widgetClass'=>DatePicker::classname(),'options'=>['pluginOptions' => [
                                'autoclose' => true,
                                'todayHighlight' => true,
                                'format' => 'dd-mm-yyyy',
                            ]],], 
		...
		'IsActive'=>['type'=> Form::INPUT_CHECKBOX, 'options'=>[array('label'=>'asd')],'label'=>'Aktif'], 
		...
		'HasilSurveyShow'=>['type'=> Form::INPUT_WIDGET, 'widgetClass'=>Select2::classname(),'options'=>['data' => [1 => 'Back Office dan Module Survey',0 => 'Back Office'], ],'label'=>'Perlihatkan Hasil Survey'],
