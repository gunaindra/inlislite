...
class TransaksiController extends Controller
{
    ...
    public function actionDaftarPeminjaman()
    {
        ...
        return $this->render('index', [
            'dataProvider' => $dataProvider,
            'searchModel' => $searchModel,
            'title' => 'Daftar Transaksi Peminjaman Locker',
            'status' => $status,
            ]);
    }
    ...
    public function actionDaftarPengembalian()
    {
        ...
        return $this->render('index', [
            'dataProvider' => $dataProvider,
            'searchModel' => $searchModel,
            'title' => 'Daftar Transaksi Pengembalian Locker',
            'status' => $status,
            ]);
    }
     ...
     * @return [type] [description]
     */
    public function actionLockerOutoforderById($id)
    {
        $masterlocker = MasterLoker::findOne($id);
        ...
        if ($model->load(Yii::$app->request->post()))
        {
            ...
            if ($model->save()) {
                if ($model->id_pelanggaran_locker == null) {
                    ...
                    $this->actionLockerOutoforderById($model->loker_id);                                   // Update Status Locker yg Rusak/hilang menjadi 'out Of Order'
                }
