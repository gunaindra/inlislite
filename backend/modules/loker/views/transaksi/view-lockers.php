...
<div class="lockers-view">
    <p> 
        ...
        <?php echo Button::widget([
                // 'label' => 'Action',
            'encodeLabel' => false,
            'label' => '<span class="glyphicon glyphicon-print"></span> Cetak ulang struk peminjaman',
    ...
    <?= DetailView::widget([
        ...
        'attributes' => [
            ...
            [
                ...
                'value'=> ( isset( $model->pelanggaran['deskripsi'] ) ) ? $model->pelanggaran['deskripsi'].' - Denda ( '.$model->pelanggaran['denda'].') ' : "Tidak ada pelanggaran",
            ],
        ],
