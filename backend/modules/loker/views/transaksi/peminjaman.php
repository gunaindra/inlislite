...
<div class="lockers-form">
    <ul id="w3" class="nav nav-tabs">
        <li class="active"><a href="#tab-peminjaman" data-toggle="tab" aria-expanded="true">Peminjaman</a></li>
        <li>
        ...
        <div id="tab-peminjaman" class="tab-pane active">
            ...
            <div class="form-horizontal">
                <table class="table table-condensed table-bordered table-striped table-hover request-table" style="table-layout: fixed;">
                    <tbody>
                        <tr>
                            <td class="col-sm-3"><label class="control-label">No. <?= Yii::t('app','Anggota') ?></label></td>
                            <td >
                                <div class="input-group">
                                    <?= Html::activeTextInput($model,'no_member',['class'=>'form-control','style'=>'width:100%','placeholder'=>Yii::t('app', 'Enter').'  No.'.Yii::t('app', 'Angota').'']); ?>
            ...
            <div class="form-horizontal" id="pilihLocker" hidden="hidden" > <!-- hidden="hidden" -->
                <table class="table table-condensed table-bordered table-striped table-hover request-table" style="table-layout: fixed;">
                    <thead>
                        <tr>
                            <td class="col-sm-3"><label class="control-label"><?= Yii::t('app','Scan').' '.Yii::t('app','Barcode') .' '.Yii::t('app','Kunci') ?></label></td>
                            <td>
                                <div class="col-sm-9" style="padding: 0;">
                                    <div class="input-group">
                                        <input id="scanBarcode" type="text" class="form-control" placeholder="<?= Yii::t('app','Scan').' '.Yii::t('app','Barcode') ?>" name="barcode_kunci" required>
                                        <div class="input-group-btn">
                                ...
                                <div class="col-sm-3" style="padding-right: 0" >
                                    <button data-toggle="modal" type="button" data-target="#piliLokerModal" class="btn btn-primary col-sm-12"><?= Yii::t('app','Pilih').' '.Yii::t('app','Loker') ?></button>
                                </div>
            ...
            <div class="" id="jaminan" hidden="hidden" > <!-- hidden="hidden" -->
                <table class="table table-condensed table-bordered table-striped table-hover request-table" style="table-layout: fixed;">
                    <thead>
                        <tr>
                            <th class="col-sm-3 "><label class="control-label">Jaminan</label></th>
                            <th>
                    ...
                    <tbody>
                        <tr id="jaminanIdentitas" hidden="hidden">
                            <td class=""><label class="control-label">Jaminan Identitas</label></td>
                            <td>
                                <div class="form-group kv-fieldset-inline">
                                    ...
                                    <?= $form->field($model, 'id_jamin_idt')->widget('\kartik\widgets\Select2',[
                                        ...
                                        'options'=> ['placeholder'=>Yii::t('app', 'Choose').' '.Yii::t('app', 'Jenis Identitas')]
                                        ])->label(false); ?>
                                    </div>
                                    <div class="col-sm-6">
                        ...
                        <tr id="jaminanUang" hidden="hidden">
                            <td class=""><label class="control-label">Jaminan Uang</label></td>
                            <td>
                                <div class="col-sm-6" style="padding: 0;">
                                ...
                                <?= $form->field($model, 'id_jamin_uang')->widget('\kartik\widgets\Select2',[
                                    ...
                                    'options'=> ['placeholder'=>Yii::t('app', 'Choose').' '.Yii::t('app', 'Jaminan Uang')]
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= Yii::t('app','Pilih').' '.Yii::t('app','Loker') ?></h4>
            </div>
        ...
        $.get('checkmembership',{ noMember : noMember },function(data){
          //  alert(data);
            if (!data) 
            {
                $('#jaminan').hide();
                $('#pilihLocker').hide();
                $('.hint-block').html('Data member atau Memberguess tidak ditemukan');
