...
<div class="lockers-form">
    <ul id="w3" class="nav nav-tabs">
        <li >
        	<a href="peminjaman" aria-expanded="false">Peminjaman</a>
        	<!-- <a href="#tab-peminjaman" data-toggle="tab" aria-expanded="true">Peminjaman</a> -->
        </li>
        <li class="active">
            <a href="#tab-pengembalian" data-toggle="tab" aria-expanded="true">Pengembalian</a>
        ...
        <div id="tab-pengembalian" class="tab-pane active">
            ...
            <?= $form->field($model, 'No_pinjaman')->hiddenInput(['placeholder'=>Yii::t('app', 'Nomor Pinjaman')])->label(false); ?> 
			 <div class="table-responsive">
                <table class="table table-condensed table-bordered table-striped table-hover request-table" style="table-layout: fixed;">
                    <tbody>
                        <tr>
                            <td class="col-sm-4"><label class="control-label">Nomor Kunci atau Nomor Pinjaman</label></td>
                            <td >
                                <div class="input-group">
      								<?php //$form->field($model, 'No_pinjaman')->textInput(['placeholder'=>Yii::t('app', 'Nomor Pinjaman')])->label(false); ?> 
                                	<input type="textInput" class="form-control" name="cariLocker" id="cariLocker" value="" placeholder="Nomor Locker atau Nomor Peminjaman" required>
                                    <div class="input-group-btn" >
                                        <button class="btn btn-success" type="button" id="searchLocker"><i class="glyphicon glyphicon-search"></i>&nbsp;Cari</button>
                                    </div><!-- /btn-group -->
			...
			<div id="Pelanggaran" hidden="hidden">
                <table class="table table-condensed table-bordered table-striped table-hover request-table" style="table-layout: fixed;">
                    <tbody>
                        <tr>
                            <td class="col-sm-4"><label class="control-label">Pelanggaran</label></td>
                            <td >
                                <?= $form->field($model, 'id_pelanggaran_locker')->widget('\kartik\widgets\Select2',[
                                    ...
                                    ])->label(false)->hint('Kosongkan jika tidak ada pelanggaran'); ?>
