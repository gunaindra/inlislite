...
$this->title = 'Baca di Tempat';

Yii::$app->view->params['subTitle'] = '<h3>Selamat Datang<br>Di '.$locationName.'</h3><h5> ('.$readedCollection['eksemplar'].' eksemplar dari '.$readedCollection['judul'] .' judul dibaca hari ini)</h5>';
        ...
        <div class="row">
            <div class="col-sm-offset-4 col-sm-4">
                <div class="input-group">
                    ...
                    <?= Html::input('text','NoAnggota',$NoAnggota,['id'=>'noAnggota','class'=>'form-control','placeholder'=>'No. anggota / pengunjung','autofocus'=>'autofocus'])  ?>
            ...
            $.get('validasi-anggota',{ noAnggota : noAnggota },function(data)
            {
                ...
                if (!data) {
                    ...
                    if (data.type == 'member')
                    {
                        ...
                        // for member photo
                        checkImage( '../../uploaded_files/foto_anggota/' + data.id +'.jpg' , 
                        function(){
                        	$('#MemberPhoto').attr('src',  '../../uploaded_files/foto_anggota/' + data.id +'.jpg');
	                    },  
	                    function(){ 
	                    	$('#MemberPhoto').attr('src',  '../../uploaded_files/foto_anggota/' + 'nophoto' +'.jpg');
                ...
                success: function(data){
                    ...
                    else
                    {
                        if (data.exist == true) {
                            ...
                            $('#warnBookScan').html('".Yii::t('app','<b class="text-success">Berhasil Tersimpan</b>')."');
                        }
                        // alert(data.Title);
                        count = 10;
                        $('#pindaiBuku').val('');
