...
$location = Locations::find()
    ...
    ->one();
Yii::$app->view->params['subTitle'] = '<h3>Selamat Datang <br>Di '.$location->Name.'</h3>
    <h5 style="display: block;">('.number_format($totalVisitors).' pengunjung hari ini)</h5>';
    ...
    <div class="col-sm-12" style="padding:0 -15px">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <!-- <li><a href="#tab_1" data-toggle="tab">Anggota</a></li> -->
                <li><a href="<?= Yii::$app->getUrlManager()->createUrl('site/member') ?>" >Anggota</a></li>
                <li class="active"><a href="#tab_2" data-toggle="tab">Non Anggota</a></li>
                ...
                <!-- form start -->
                    <form class="form-horizontal">
                        <div class="box-body">
                            ...
                            <div class="row form-group">
                                <label class="col-sm-3 col-sm-offset-1 control-label">Tujuan</label>
                                <div class="col-sm-7">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <button type="button" onClick="window.location.href=window.location.href" class="btn btn-default">Ulangi</button>
                            </div>
                        </div>
                        <div class="col-sm-4"></div>
