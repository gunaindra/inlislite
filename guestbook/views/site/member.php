...
$location = Locations::find()
    ...
    ->one();
Yii::$app->view->params['subTitle'] = '<h3>Selamat Datang <br>Di '.$location->Name.'</h3><h5 style="display: block;">('.number_format($totalVisitors).' pengunjung hari ini)</h5>';
    ...
    <div class="col-sm-12" style="padding:0 -15px">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <li><a href="<?= Yii::$app->getUrlManager()->createUrl('site/nonmember') ?>">Non Anggota</a></li>
                <li><a href="<?= Yii::$app->getUrlManager()->createUrl('site/group')?>">Rombongan</a></li>
            </ul>
	        	...
	        	<div class="row">
	        		<div class="col-sm-offset-4 col-sm-4">
	        			<div class="input-group">
	        				...
	        				<?= Html::input('text','Memberguesses[NoAnggota]',$NoAnggota,['id'=>'ContentPlaceHolder1_txtNoAnggota','class'=>'form-control','placeholder'=>'No. anggota / pengunjung','autofocus'=>'autofocus'])  ?>
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            if (data.StatusAnggota == null){
                $('#message-nomember').html('Maaf, anda belum terdaftar');
                // clear-data;
                $('#namaMember').html('');
                ...
                // for member photo
                checkImage( "$urlpoto" + "/" + $('#MemberID').val() + '.jpg' , 
                    function(){
                        $("#MemberPhoto").attr('src',  "$urlpoto" + "/" + $('#MemberID').val() +'.jpg');
                    },  
                    function(){ 
